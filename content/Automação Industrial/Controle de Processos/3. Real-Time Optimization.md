...
---
# 3. Mais informações
# 🧠 1️⃣ O RTO como algoritmo

Um RTO normalmente:

- Recebe dados do processo
    
- Resolve um problema de otimização (ex: programação não linear)
    
- Gera setpoints ótimos
    
- Envia recomendações ou ajustes
...
# 🏗 2️⃣ Mas o RTO real não é só isso

Em ambiente industrial real, o sistema RTO inclui:
...
O solver de otimização.

### 🔹 D) API de exposição

Para:

- Operadores visualizarem resultados
    
- Sistemas externos consultarem
